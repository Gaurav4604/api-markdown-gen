...
if __name__ == "__main__":
    ...
    #     f.close()
    yml = None
    with open("yml/historical_weather_api.yml", "r", encoding="utf-8") as f:
        yml = yaml.dump(
            {
                "api-endpoint": "https://archive-api.open-meteo.com/v1/archive",
                "parameters": yaml.safe_load(f),
                "tags": ["historical-data"],
                "file": "historical_weather_api.yml",
            },
        ...
        f.close()
    with open("yml/historical_weather_api.yml", "w", encoding="utf-8") as f:
        f.write(yml)
        f.close()
